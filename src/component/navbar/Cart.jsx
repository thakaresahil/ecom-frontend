...
function Cart() {
  const cartItem = useSelector(state => state.carter);
  return (
    <div className="py-2 px-4 text-gray-900 rounded hover:bg-gray-100 flex items-center">
      ...
      <h1 className="text-sm">{cartItem}</h1>
    </div>
  );
}
